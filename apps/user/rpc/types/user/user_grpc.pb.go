...
// UserClient is the client API for User apps.
//
...
// UserServer is the server API for User apps.
...
// UnsafeUserServer may be embedded to opt out of forward compatibility for this apps.
...
// User_ServiceDesc is the grpc.ServiceDesc for User apps.
